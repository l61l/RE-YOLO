...
class Colors:
    ...
    def __init__(self):
        """ YOLOv8n 00FFFF Cyan RE-YOLOv8 7FFF00 Chartreuse      Initialize colors as hex = matplotlib.colors.TABLEAU_COLORS.values().   """
        hexs = ('00FFFF','FF3838', 'FF9D97', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(240, 10, 10)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                outside = p1[1] - h >= 3
                p2 = p1[0] + w, p1[1] - h - 9 if outside else p1[1] + h + 3
                cv2.rectangle(self.im, p1, p2, color, -1, cv2.LINE_AA)  # filled
                cv2.putText(self.im,
                            label, (p1[0]+2, p1[1] - 7 if outside else p1[1] + h + 1),
                            0,
                            self.sf,
                            txt_color,
                            thickness=self.tf,
